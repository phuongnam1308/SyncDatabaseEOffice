...
// T? d?ng nh?n di?n m�i tru?ng SEA (EXE) hay Dev
...
async function loginKeycloak(options = {}) {
  ...
  try {
    const launchOptions = {
      headless: true, // �p ch?y ng?m ho�n to�n
      executablePath: executablePath,
      args: [
        '--headless=new', // Th�m c? headless c?a Chrome d? ?n ho�n to�n giao di?n
