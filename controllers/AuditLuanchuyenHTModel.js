...
class AuditLuanchuyenHTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_HT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from HT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenHTModel;