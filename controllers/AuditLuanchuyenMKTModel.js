...
class AuditLuanchuyenMKTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_MKT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from MKT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenMKTModel;