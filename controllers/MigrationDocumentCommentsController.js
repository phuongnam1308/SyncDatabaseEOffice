...
const MigrationDocumentCommentsService =
  require('../services/MigrationDocumentCommentsService');
/**
 * @swagger
 * tags:
 ...
 */
class MigrationDocumentCommentsController extends BaseController {
  constructor() {
    super();
    this.service = null;
  }
  ...
  async initService() {
    if (!this.service) {
      this.service = new MigrationDocumentCommentsService();
...
module.exports = new MigrationDocumentCommentsController();
