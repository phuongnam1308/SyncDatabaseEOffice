...
const MigrationDocumentCommentsServiceATPC =
  require('../services/updates/MigrateIncomingDocumentsServiceATPC');
/**
 * @swagger
 * tags:
 ...
 */
class MigrationDocumentCommentsControllerATPC extends BaseController {
  constructor() {
    super();
    this.service = null;
  }
  ...
  async initService() {
    if (!this.service) {
      this.service = new MigrationDocumentCommentsServiceATPC();
...
module.exports = new MigrationDocumentCommentsControllerATPC();
