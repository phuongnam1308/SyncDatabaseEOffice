...
class AuditLuanchuyenKTVTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_KTVT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from KTVT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenKTVTModel;