...
class AuditLuanchuyenCBQLModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_CBQL';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from CBQL failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenCBQLModel;