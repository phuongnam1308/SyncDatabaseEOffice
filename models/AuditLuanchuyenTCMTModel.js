...
class AuditLuanchuyenTCMTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TCMT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TCMT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTCMTModel;