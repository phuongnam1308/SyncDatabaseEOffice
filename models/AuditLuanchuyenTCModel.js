...
class AuditLuanchuyenTCModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TC';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TC failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTCModel;