...
class AuditLuanchuyenTCOModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TCO';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TCO failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTCOModel;