...
class AuditLuanchuyenTCOTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TCOT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TCOT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTCOTModel;