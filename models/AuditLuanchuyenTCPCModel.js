...
class AuditLuanchuyenTCPCModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TCPC';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TCPC failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTCPCModel;