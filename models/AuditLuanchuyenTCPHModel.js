...
class AuditLuanchuyenTCPHModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TCPH';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TCPH failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTCPHModel;