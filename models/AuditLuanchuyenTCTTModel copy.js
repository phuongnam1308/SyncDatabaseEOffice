...
class AuditLuanchuyenTCTTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TCTT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TCTT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTCTTModel;