...
class AuditLuanchuyenTTDDCModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TTDDC';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TTDDC failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTTDDCModel;