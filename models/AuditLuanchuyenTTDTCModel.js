...
class AuditLuanchuyenTTDTCModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_TTDTC';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from TTDTC failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenTTDTCModel;