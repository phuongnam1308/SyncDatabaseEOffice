...
class AuditLuanchuyenVPMBModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_VPMB';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from VPMB failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenVPMBModel;