...
class AuditLuanchuyenVPModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_VP';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from VP failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenVPModel;