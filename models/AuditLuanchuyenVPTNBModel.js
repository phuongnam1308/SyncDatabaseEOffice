...
class AuditLuanchuyenVPTNBModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_VPTNB';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from VPTNB failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenVPTNBModel;