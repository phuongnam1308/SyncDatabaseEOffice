...
class AuditLuanchuyenVTBModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_VTB';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from VTB failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenVTBModel;