...
class AuditLuanchuyenVTTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_VTT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from VTT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenVTTModel;