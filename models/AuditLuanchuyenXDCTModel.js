...
class AuditLuanchuyenXDCTModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_XDCT';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from XDCT failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenXDCTModel;