...
class AuditLuanchuyenXNCGModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_XNCG';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from XNCG failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenXNCGModel;