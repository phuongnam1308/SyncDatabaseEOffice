...
class AuditLuanchuyenYTEModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_YTE';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from YTE failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenYTEModel;