...
class AuditLuanchuyenXDSMModel extends BaseModel {
  constructor() {
    super();
    this.oldTable = 'LuanChuyenVanBan_XDSM';
    this.oldSchema = 'dbo';
  ...
  async insertToNewDb(row) {
    try {
      ...
      logger.error('Insert audit3 from XDSM failed:', err);
      throw err;
    }
  }
}

module.exports = AuditLuanchuyenXDSMModel;