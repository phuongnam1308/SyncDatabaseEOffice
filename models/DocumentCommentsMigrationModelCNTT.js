...
} = require('../config/documentCommentsMigrationCNTT.config');

class DocumentCommentsMigrationModelCNTT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelCNTT;
