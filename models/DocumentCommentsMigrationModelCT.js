...
} = require('../config/documentCommentsMigrationCT.config');

class DocumentCommentsMigrationModelCT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelCT;
