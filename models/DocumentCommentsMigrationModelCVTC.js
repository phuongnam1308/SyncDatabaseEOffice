...
} = require('../config/documentCommentsMigrationCVTC.config');

class DocumentCommentsMigrationModelCVTC extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelCVTC;
