...
} = require('../config/documentCommentsMigrationDVHH.config');

class DocumentCommentsMigrationModelDVHH extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelDVHH;
