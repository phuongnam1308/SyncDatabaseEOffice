...
} = require('../config/documentCommentsMigrationDVKT.config');

class DocumentCommentsMigrationModelDVKT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelDVKT;
