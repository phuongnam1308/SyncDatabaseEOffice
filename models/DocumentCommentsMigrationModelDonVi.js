...
} = require('../config/documentCommentsMigrationDonVi.config');

class DocumentCommentsMigrationModelDonVi extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelDonVi;
