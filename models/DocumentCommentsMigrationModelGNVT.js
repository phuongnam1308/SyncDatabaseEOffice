...
} = require('../config/documentCommentsMigrationGNVT.config');

class DocumentCommentsMigrationModelGNVT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelGNVT;
