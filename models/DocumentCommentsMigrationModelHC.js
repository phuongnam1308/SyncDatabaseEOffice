...
} = require('../config/documentCommentsMigrationHC.config');

class DocumentCommentsMigrationModelHC extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelHC;
