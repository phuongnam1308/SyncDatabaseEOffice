...
} = require('../config/documentCommentsMigrationHT.config');

class DocumentCommentsMigrationModelHT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelHT;
