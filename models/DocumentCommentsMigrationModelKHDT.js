...
} = require('../config/documentCommentsMigrationKHDT.config');

class DocumentCommentsMigrationModelKHDT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelKHDT;
