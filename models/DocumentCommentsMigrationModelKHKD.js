...
} = require('../config/documentCommentsMigrationKHKD.config');

class DocumentCommentsMigrationModelKHKD extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelKHKD;
