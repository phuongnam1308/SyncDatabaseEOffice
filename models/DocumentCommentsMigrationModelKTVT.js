...
} = require('../config/documentCommentsMigrationKTVT.config');

class DocumentCommentsMigrationModelKTVT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelKTVT;
