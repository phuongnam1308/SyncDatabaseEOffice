...
} = require('../config/documentCommentsMigrationKVTC.config');

class DocumentCommentsMigrationModelKVTC extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelKVTC;
