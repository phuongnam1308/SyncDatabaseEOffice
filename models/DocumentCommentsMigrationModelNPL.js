...
} = require('../config/documentCommentsMigrationNPL.config');

class DocumentCommentsMigrationModelNPL extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelNPL;
