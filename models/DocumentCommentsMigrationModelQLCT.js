...
} = require('../config/documentCommentsMigrationQLCT.config');

class DocumentCommentsMigrationModelQLCT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelQLCT;
