...
} = require('../config/documentCommentsMigrationQSBV.config');

class DocumentCommentsMigrationModelQSBV extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelQSBV;
