...
} = require('../config/documentCommentsMigrationSNPL.config');

class DocumentCommentsMigrationModelSNPL extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelSNPL;
