...
} = require('../config/documentCommentsMigrationTC.config');

class DocumentCommentsMigrationModelTC extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTC;
