...
} = require('../config/documentCommentsMigrationTC189.config');

class DocumentCommentsMigrationModelTC189 extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTC189;
