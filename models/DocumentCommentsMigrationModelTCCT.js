...
} = require('../config/documentCommentsMigrationTCCT.config');

class DocumentCommentsMigrationModelTCCT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCCT;
