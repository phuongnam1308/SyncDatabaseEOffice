...
} = require('../config/documentCommentsMigrationTCHP.config');

class DocumentCommentsMigrationModelTCHP extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCHP;
