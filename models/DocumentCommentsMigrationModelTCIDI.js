...
} = require('../config/documentCommentsMigrationTCIDI.config');

class DocumentCommentsMigrationModelTCIDI extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCIDI;
