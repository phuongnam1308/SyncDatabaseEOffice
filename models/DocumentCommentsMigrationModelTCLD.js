...
} = require('../config/documentCommentsMigrationTCLD.config');

class DocumentCommentsMigrationModelTCLD extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCLD;
