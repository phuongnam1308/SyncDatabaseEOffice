...
} = require('../config/documentCommentsMigrationTCMT.config');

class DocumentCommentsMigrationModelTCMT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCMT;
