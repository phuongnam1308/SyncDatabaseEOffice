...
} = require('../config/documentCommentsMigrationTCO.config');

class DocumentCommentsMigrationModelTCO extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCO;
