...
} = require('../config/documentCommentsMigrationTCOT.config');

class DocumentCommentsMigrationModelTCOT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCOT;
