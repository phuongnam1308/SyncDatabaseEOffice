...
} = require('../config/documentCommentsMigrationTCPC.config');

class DocumentCommentsMigrationModelTCPC extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCPC;
