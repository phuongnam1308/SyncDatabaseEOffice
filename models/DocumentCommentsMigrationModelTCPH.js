...
} = require('../config/documentCommentsMigrationTCPH.config');

class DocumentCommentsMigrationModelTCPH extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCPH;
