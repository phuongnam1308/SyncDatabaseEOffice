...
} = require('../config/documentCommentsMigrationTCTT.config');

class DocumentCommentsMigrationModelTCTT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTCTT;
