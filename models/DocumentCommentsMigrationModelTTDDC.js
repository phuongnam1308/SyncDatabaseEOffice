...
} = require('../config/documentCommentsMigrationTTDDC.config');

class DocumentCommentsMigrationModelTTDDC extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTTDDC;
