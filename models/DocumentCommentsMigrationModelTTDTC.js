...
} = require('../config/documentCommentsMigrationTTDTC.config');

class DocumentCommentsMigrationModelTTDTC extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelTTDTC;
