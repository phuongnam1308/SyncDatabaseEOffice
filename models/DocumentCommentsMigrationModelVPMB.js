...
} = require('../config/documentCommentsMigrationVPMB.config');

class DocumentCommentsMigrationModelVPMB extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelVPMB;
