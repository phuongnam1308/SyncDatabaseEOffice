...
} = require('../config/documentCommentsMigrationVPTNB.config');

class DocumentCommentsMigrationModelVPTNB extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelVPTNB;
