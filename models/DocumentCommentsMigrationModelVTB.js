...
} = require('../config/documentCommentsMigrationVTB.config');

class DocumentCommentsMigrationModelVTB extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelVTB;
