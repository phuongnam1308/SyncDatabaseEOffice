...
} = require('../config/documentCommentsMigrationVTT.config');

class DocumentCommentsMigrationModelVTT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelVTT;
