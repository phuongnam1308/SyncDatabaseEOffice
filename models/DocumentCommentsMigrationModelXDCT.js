...
} = require('../config/documentCommentsMigrationXDCT.config');

class DocumentCommentsMigrationModelXDCT extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelXDCT;
