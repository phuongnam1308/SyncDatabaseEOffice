...
} = require('../config/documentCommentsMigrationYTE.config');

class DocumentCommentsMigrationModelYTE extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelYTE;
