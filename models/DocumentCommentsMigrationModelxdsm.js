...
} = require('../config/documentCommentsMigrationxdsm.config');

class DocumentCommentsMigrationModelxdsm extends BaseModel {
  constructor() {
    super();
...
module.exports = DocumentCommentsMigrationModelxdsm;
