 ...
 * MigrationHelper
 * 
 * Helper class chứa các hàm tiện ích cho migration
 * Tách biệt logic xử lý dữ liệu khỏi model để dễ bảo trì và test
 */
class MigrationHelper extends BaseModel{
  /**
  ...
  processDocumentType(value) {
    return this._processDocumentType(value);
  }

  processUrgencyLevel(value) {
    return this._processUrgencyLevel(value);
  }

  processPrivateLevel(value) {
    return this._processPrivateLevel(value);
  }

  mapSenderUnitId(value, transaction = null) {
    return this._mapSenderUnitId(value, transaction);
  }

  mapUserName(name, transaction = null) {
    return this._mapUserName(name, transaction);
  }

  mapBookDocument(bookName, options = {}) {
    return this._mapBookDocument(bookName, options);
  }
