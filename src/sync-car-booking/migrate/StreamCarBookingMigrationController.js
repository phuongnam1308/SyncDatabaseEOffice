...
const StreamCarBookingMigrationService = require('./StreamCarBookingMigrationService');

const DEFAULT_SYNC_TIME = '1970-01-01T00:00:00.000Z';

class StreamCarBookingMigrationController extends BaseController {
    constructor() {
        super();
        this.service = new StreamCarBookingMigrationService();
    }
    ...
    testGetList = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamCarBookingMigrationController.testGetList] Error:', error);
    ...
    testProcessOne = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamCarBookingMigrationController.testProcessOne] Error:', error);
            return this.error(res, 'Unit test processOne thất bại.', 500, error);
        }
    });
}

module.exports = new StreamCarBookingMigrationController();
