...
const StreamEventMigrationService = require('./StreamEventMigrationService');

const DEFAULT_SYNC_TIME = '1970-01-01T00:00:00.000Z';

class StreamEventMigrationController extends BaseController {
    constructor() {
        super();
        this.service = new StreamEventMigrationService();
    }
    ...
    testGetList = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamEventMigrationController.testGetList] Error:', error);
    ...
    testProcessOne = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamEventMigrationController.testProcessOne] Error:', error);
            return this.error(res, 'Unit test processOne thất bại.', 500, error);
        }
    });
}

module.exports = new StreamEventMigrationController();
