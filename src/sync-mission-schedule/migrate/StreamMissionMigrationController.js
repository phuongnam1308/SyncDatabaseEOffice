...
const StreamMissionMigrationService = require('./StreamMissionMigrationService');

const DEFAULT_SYNC_TIME = '1970-01-01T00:00:00.000Z';

class StreamMissionMigrationController extends BaseController {
    constructor() {
        super();
        this.service = new StreamMissionMigrationService();
    }
    ...
    testGetList = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamMissionMigrationController.testGetList] Error:', error);
    ...
    testProcessOne = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamMissionMigrationController.testProcessOne] Error:', error);
            return this.error(res, 'Unit test processOne thất bại.', 500, error);
        }
    });
}

module.exports = new StreamMissionMigrationController();
