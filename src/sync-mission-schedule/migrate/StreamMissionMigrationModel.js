...
class StreamMissionMigrationModel extends BaseIncrementalSyncInterface {
  ...
  async getList(lastSyncTime, syncJobId, lastSyncId = 0) {
    ...
    console.log(`[StreamMissionMigrationModel] Total records to sync: ${totalCount}`);
    ...
    for (let i = 0; i < numIterations; i++) {
        ...
        logger.info(`[StreamMissionMigrationModel] Fetching batch ${i + 1}/${numIterations} (Offset: ${offset}, Limit: ${fetchBatchSize})`);
        ...
        logger.info(`🔥 [StreamMissionMigrationModel] Batch ${i + 1}/${numIterations} staged: ${totalStagedCount}/${totalCount}. LastSyncTime: ${nextSyncTime}, LastSyncId: ${nextSyncId}`);
    }
