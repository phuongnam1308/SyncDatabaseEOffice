const StreamMissionMigrationModel = require('./StreamMissionMigrationModel');
const SyncManagerService = require('../../sync-manager/SyncManagerService');

const UNIT_TEST_MODEL_NAME = 'UNIT_TEST_STREAM_MISSION_MIGRATION';
const DEFAULT_SYNC_TIME = '1970-01-01T00:00:00.000Z';

class StreamMissionMigrationService {
    constructor() {
        this.model = null;
    }
    ...
    async initialize() {
        ...
        this.model = new StreamMissionMigrationModel();
...
module.exports = StreamMissionMigrationService;
