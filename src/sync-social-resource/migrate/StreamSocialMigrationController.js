...
const StreamSocialMigrationService = require('./StreamSocialMigrationService');

const DEFAULT_SYNC_TIME = '1970-01-01T00:00:00.000Z';

class StreamSocialMigrationController extends BaseController {
    constructor() {
        super();
        this.service = new StreamSocialMigrationService();
    }
    ...
    testGetList = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamSocialMigrationController.testGetList] Error:', error);
    ...
    testProcessOne = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamSocialMigrationController.testProcessOne] Error:', error);
            return this.error(res, 'Unit test processOne thất bại.', 500, error);
        }
    });
}

module.exports = new StreamSocialMigrationController();
