const StreamSocialMigrationModel = require('./StreamSocialMigrationModel');
const SyncManagerService = require('../../sync-manager/SyncManagerService');

const UNIT_TEST_MODEL_NAME = 'UNIT_TEST_STREAM_SOCIAL_RESOURCE_MIGRATION1';
const DEFAULT_SYNC_TIME = '1970-01-01T00:00:00.000Z';

class StreamSocialMigrationService {
    constructor() {
        this.model = null;
    }
    ...
    async initialize() {
        ...
        this.model = new StreamSocialMigrationModel();
...
module.exports = StreamSocialMigrationService;
