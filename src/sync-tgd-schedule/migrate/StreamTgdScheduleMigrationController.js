...
const StreamTgdScheduleMigrationService = require('./StreamTgdScheduleMigrationService');

const DEFAULT_SYNC_TIME = '1970-01-01T00:00:00.000Z';

class StreamTgdScheduleMigrationController extends BaseController {
    constructor() {
        super();
        this.service = new StreamTgdScheduleMigrationService();
    }
    ...
    testGetList = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamTgdScheduleMigrationController.testGetList] Error:', error);
    ...
    testProcessOne = this.asyncHandler(async (req, res) => {
        ...
        try {
            ...
            logger.error('[StreamTgdScheduleMigrationController.testProcessOne] Error:', error);
            return this.error(res, 'Unit test processOne thất bại.', 500, error);
        }
    });
}

module.exports = new StreamTgdScheduleMigrationController();
